...
export const PIPELINE_STAGES = {
  analyzing_jd: { label: 'Analyzing Job Description', weight: 15, color: '#3b82f6' },
  matching_achievements: { label: 'Matching Experience', weight: 20, color: '#8b5cf6' },
  generating_draft: { label: 'Generating Draft', weight: 25, color: '#ec4899' },
...
export const STATUS_COLORS = {
  ...
  processing: 'text-yellow-600 bg-yellow-100 dark:bg-yellow-900/30 dark:text-yellow-400',
...
export const OUTPUT_BACKENDS = [
  { value: 'weasyprint', label: 'WeasyPrint (Fast)', description: 'CSS-based PDF generation' },
  { value: 'latex', label: 'LaTeX (Professional)', description: 'Academic-quality typesetting' },
];
