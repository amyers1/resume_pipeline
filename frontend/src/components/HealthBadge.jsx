...
export default function HealthBadge() {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-background-surface rounded-lg shadow-lg border border-slate-200 dark:border-slate-700 py-2 z-50">
                    ...
                    <div className="px-4 py-2">
                        ...
                        {health.error && (
                            <p className="text-xs text-red-500 mt-2 pt-2 border-t border-slate-100 dark:border-slate-700">
                                Error: {health.error}
                            </p>
                        )}
                    </div>
