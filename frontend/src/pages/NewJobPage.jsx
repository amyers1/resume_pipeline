...
export default function NewJobPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.fullText.trim()) newErrors.fullText = 'Job description is required';
    else if (formData.fullText.trim().length < 50) {
      newErrors.fullText = 'Job description must be at least 50 characters';
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.message || 'Failed to submit job';
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              />
              {errors.fullText && (
                <p className="text-red-500 text-sm mt-1">{errors.fullText}</p>
              )}
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              >
                {profiles.length > 0 ? (
                  ...
                  <option value="career_profile.json">career_profile.json</option>
                )}
              </select>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                {
                  OUTPUT_BACKENDS.find((b) => b.value === formData.outputBackend)
                    ?.description
                }
              </p>
            </div>
